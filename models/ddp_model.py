...
import sys
class Model:
    def __init__(self,cfg,net_arch,loss_f=None,optimizer=None,scheduler=None,rank=0,eval=None):
        self.cfg = cfg
        ...
        for k, v in loaded_net.items():
            if self.cfg.dist.gpus==0:
                ...
                if not k.startswith("module."):
                    loaded_clean_net["module."+k] = v
                else:
                    loaded_clean_net[k] = v

        # print(loaded_clean_net.keys())
        # print(self.net)
